...
# create a list to store these models ------------------------------------------
bird_size_models <- list(PD = mm02b_birds_size_pd, FR = mm02b_birds_size_fr, SR = mm02b_birds_size_sr)
mammals_size_models <- list(PD = mm02b_mammals_size_pd, FR = mm02b_mammals_size_fr, SR = mm02b_mammals_size_sr)

bird_dist_models <- list(PD = mm02d_birds_dist_pd, FR = mm02d_birds_dist_fr, SR = mm02d_birds_dist_sr)
mammals_dist_models <- list(PD = mm02d_mammals_dist_pd, FR = mm02d_mammals_dist_fr, SR = mm02d_mammals_dist_sr)
