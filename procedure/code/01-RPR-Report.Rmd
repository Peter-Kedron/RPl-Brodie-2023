...
To adjust for effect of connectivity on PA efficacy, we computationally reproduced the findings of Brodie et al. using the data shared by the authors, and extended the original analysis by introducing habitat connectivity as an independent predictor of bird biodiversity and a moderator of the PA effect.
We find that ...

MAYBE ADD - Debates exist on whether protected areas are effective because of their remote location and good habitat conditions or conservation status itself. Motivated by such, Brodie et al. (2023) estimated protected areas efficacy for conserving tropical mammal and bird diversity after de-confounding the effects of site accessibility and habitat condition (OR-H1). To test the hypothesis, Brodie et al. (2023) used various aspects of biodiversity as outcome variables (i.e., dependent variable). 


# Study design

This study is a replication of the original statistical analysis of Brodie et al. (2023).
We conduct two related analyses to evaluate and extend the work of the original authors. 
First, we attempt to reproduce the statistical results of the original authors by implementing their workflow as identically as possible. 
This effort allows us to assess study design and conclusion validity of the original study. 
Second, we extend the work of the original authors by introducing PA connectivity as a predictor of bird and mammal biodiversity and a potential moderator of PA efficacy.
We also examine whether the beneficial spillover effects observed around protected areas persist when adjusting for PA connectivity.
...
The spatial extent of this study is Southeast Asia, matching the area studied by the original authors. 
...
Our primary data source is the data file publicly shared by Brodie et al. (2023). 
All data acquisition from original sources followed the procedures presented by the authors. 
The original study and our replication attempts were conducted in R. 
The DAGITTY package was used for structural causal modeling.
The NLME package used for statistical estimation. 
...
The primary variable of interest was binary measure indicating whether a observation site was located inside or outside a PA. 
...
> OR-Ho-2a: The total area of the protected area located closest to an unprotected observation site has not effect on the level of mammalian of avian biodiversity observed at that site when adjusting for the confounds of site accessibility, habitat condition, and the socioeconomic development.

> OR-Ho-2b: The distance to the protected area located closest to an unprotected observation site has not effect on the level of mammalian of avian biodiversity observed at that site when adjusting for the confounds of site accessibility, habitat condition, and the socioeconomic development.
