...
### Camera trap
Brodie et al. placed camera traps and preprocessed these data to construct the biodiversity measures for mammals that are then used as response variables in statistical modeling. 
The authors did not provide scripts on how they derived the biodiversity metrics.

- `Title`: Camera trap.
- `Abstract`: A community science platform for reporting bird sightings.
- `Spatial Coverage`: Southeast Asia (overlapping countries of Brunei, Cambodie, China, Indonesia, Laos, Malaysia, Singapore, Thailand, and Vietnam).
- `Spatial Resolution`: Vector data model with point observations of species occurrence
- `Spatial Reference System`: Not specified.
- `Temporal Coverage`: 
- `Temporal Resolution`: Not applicable.
- `Lineage`: Brodie et al. (2023) collected the data
