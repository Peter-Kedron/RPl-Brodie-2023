...
## Metadata of the original study
...
## Metadata of data sources used in the original study
...
The original study used protected area boundaries to derive the three treatment variables (Table 3). Brodie et al. (2023) did not specify how they cleaned up protected area boundary. 
...
Human Development Index for each country was included in the causal models as a simple metric of level of socioeconomic development.
