...
- `Spatial Resolution`: Vector data model with point observations of species occurrence
- `Spatial Reference System`: Not specified.
- `Temporal Coverage`: Not sepceified.
- `Temporal Resolution`: Not applicable.
- `Lineage`: Brodie et al. (2023) cleaned, filtered, and standardzied data, and used data from the most recent year if a station contains multi-year information.
