...
```{r rpr_cor_eff, echo = TRUE, results = 'show', message = FALSE, eval = FALSE, include = TRUE}
...
```{r rpr_cor_eff_tab, echo = TRUE, warning = FALSE, message = FALSE}

# Insert code to construct a summary table of efficacy models like Brodie et al.
# maybe should use with KableExtra to construct customized tables
...
# r.squaredGLMM() --> compute R squared values
```
