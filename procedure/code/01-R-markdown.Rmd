...
msummary(list('Mammal PD'=mod_PD_efficacy_mam, 'Mammal FR'=mod_FR_efficacy_mam, 'Mammal SR'=mod_SR_efficacy_mam),stars = TRUE)
...
We compare reproduction results with Extended Table 1 reported in the original paper.
