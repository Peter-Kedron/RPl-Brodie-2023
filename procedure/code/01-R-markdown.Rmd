...
> H1: Biodiversity is higher within protected areas than outside (after removing effects of site accessbility and habitat condition).
...
> H2: Biodiversity outside protected areas is higher when they are near large ones (size effect). 

They built separate models for birds and mammals on three different diversity metrics and tested H2 using observations outside protected areas. The treatment variable was a binary variable indicating whether the observation point was close to a large (i.e., ≥ 500 km^2) reserve or small (i.e., < 500 km^2). They went through the same matching steps.

Brodie et al. (2023) found that 

> H3: Biodiversity outside protected areas is higher when they are closer (distance effect).
...
> H4: Connectivity mdoerates the efficacy of protection on biodiversity.
