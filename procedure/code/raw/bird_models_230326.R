...
dat1 <- subset(dat, select = c(station, country, utm_east, utm_north, utm_east.z, utm_north.z, 
	elev.z, elev2.z, slope.z, slope2.z, TPI.z, 
	HDI.z, Gini.z, access_log10.z, 
	...
	asymptSR, maxFRic, asymptPD, median.body.size, SR.mean, SR.lo, SR.hi, Shan.mean, Shan.lo, Shan.hi)) 
...
summary(pc) # first 2 axes represent 70.0% of variance in data
